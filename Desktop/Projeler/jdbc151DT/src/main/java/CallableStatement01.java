...
//       1. Örnek: Selamlama yapan bir function'ı Callable Statement ile çağırınız
        ...
        //4. Adim: Return icin registerOutParameter() methodunu, parametreler icin setInt, setString() methotlari kullanilir
        callableStatement.registerOutParameter(1, Types.VARCHAR);
        callableStatement.setString(2, "Ali");
        // 5. Adim
        callableStatement.execute();
        //6.Adim: Sonucu görmek icin callableStatement data türünü cagiralim
